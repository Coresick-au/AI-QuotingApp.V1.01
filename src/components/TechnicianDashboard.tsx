        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-100px)]">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 flex flex-col">
                <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50 rounded-t-lg">
                    <h3 className="font-semibold text-slate-700">Technicians</h3>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-1">
                    {savedTechnicians.length === 0 ? (
                        ...
                        savedTechnicians.map((tech) => (
                            <div
                                key={tech}
                                className="w-full text-left px-4 py-3 rounded-md flex items-center justify-between group hover:bg-slate-50"
                            >
